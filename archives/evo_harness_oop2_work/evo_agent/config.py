...
class HarnessConfig:
    ...
    search_text_max_top_k: int = field(default_factory=lambda: _env_int("SEARCH_TEXT_MAX_TOP_K", "3"))
    search_text_max_chars: int = field(default_factory=lambda: _env_int("SEARCH_TEXT_MAX_CHARS", "350"))
    ...
    search_text_default_fetch: bool = field(default_factory=lambda: _env_bool("SEARCH_TEXT_DEFAULT_FETCH", "0"))
    search_image_default_fetch: bool = field(default_factory=lambda: _env_bool("SEARCH_IMAGE_DEFAULT_FETCH", "0"))
    search_stale_result_limit: int = field(default_factory=lambda: _env_int("SEARCH_STALE_RESULT_LIMIT", "2"))
    search_text_broad_query_fetch: bool = field(
        default_factory=lambda: _env_bool("SEARCH_TEXT_BROAD_QUERY_FETCH", "0")
    )
    max_search_calls_per_case: int = field(default_factory=lambda: _env_int("MAX_SEARCH_CALLS_PER_CASE", "4"))
    browser_url_failure_limit: int = field(default_factory=lambda: _env_int("BROWSER_URL_FAILURE_LIMIT", "1"))
    max_tool_calls_per_step: int = field(default_factory=lambda: _env_int("MAX_TOOL_CALLS_PER_STEP", "1"))
    context_recent_steps: int = field(default_factory=lambda: _env_int("CONTEXT_RECENT_STEPS", "6"))
    ...
    answer_repair_attempts: int = field(default_factory=lambda: _env_int("ANSWER_REPAIR_ATTEMPTS", "2"))
    ...
    case_reflection_max_steps: int = field(
        default_factory=lambda: _env_int(
            "CASE_REFLECTION_MAX_STEPS", os.getenv("SELF_REFLECTION_MAX_STEPS", "2")
        )
    )
