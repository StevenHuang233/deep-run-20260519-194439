...
class HarnessConfig:
    ...
    search_text_max_chars: int = field(default_factory=lambda: _env_int("SEARCH_TEXT_MAX_CHARS", "800"))
    ...
    search_stale_result_limit: int = field(default_factory=lambda: _env_int("SEARCH_STALE_RESULT_LIMIT", "3"))
    search_text_broad_query_fetch: bool = field(
        default_factory=lambda: _env_bool("SEARCH_TEXT_BROAD_QUERY_FETCH", "0")
    )
    max_search_calls_per_case: int = field(default_factory=lambda: _env_int("MAX_SEARCH_CALLS_PER_CASE", "12"))
    ...
    memory_retrieve_top_k: int = field(default_factory=lambda: _env_int("MEMORY_RETRIEVE_TOP_K", "2"))
