...
class HarnessConfig:
    ...
    search_text_max_top_k: int = field(default_factory=lambda: _env_int("SEARCH_TEXT_MAX_TOP_K", "8"))
    search_text_max_chars: int = field(default_factory=lambda: _env_int("SEARCH_TEXT_MAX_CHARS", "1200"))
